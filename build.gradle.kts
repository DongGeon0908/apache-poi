...
object DependencyVersion {
    ...
    const val APACHE_POI_VERSION = "5.2.2"
}
...
dependencies {
    ...
    /** poi */
    implementation("org.apache.poi:poi:${DependencyVersion.APACHE_POI_VERSION}")
    implementation("org.apache.poi:poi-ooxml:${DependencyVersion.APACHE_POI_VERSION}")
